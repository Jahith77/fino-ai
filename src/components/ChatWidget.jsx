...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      {open && (
        <div className="fixed bottom-6 right-6 w-full max-w-sm h-[500px] bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl flex flex-col z-50 overflow-hidden">
